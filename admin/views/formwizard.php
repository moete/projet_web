...
<!-- Mirrored from www.spruko.com/demo/splite/formwizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Feb 2019 18:34:49 GMT -->
<head>
									...
									<div class="card">																	
										...
										<form class="form-horizontal" method="POST">
											<div class="form-group row">
												...
												<div class="col-md-9">
													<input class="form-control" type="text" name="nom" value="<?php echo $nom; ?>" onblur="verifnom(this);">
												</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-9">
													<input class="form-control" type="text" name="mail" value="<?php echo $mail; ?>" onblur="verifMail(this);">
												</div>
                               		...
                               		<div class="form-group row">
												...
												<div class="col-md-9">
													<input class="form-control" type="tel" name="tel" value="<?php echo $tel; ?>" onblur="veriftel(this);">
												</div>
											</div>
											<div class="form-group row mb-0">
												<label class="col-md-3 col-form-label">Type de permis</label>
												<div class="col-md-9">
													<select class="form-control" name="permis" value="<?php echo $permis; ?>">
														<option>A</option>
														<option>b</option>
														<option>c</option>
														<option>d</option>
											...
											<input type="hidden" name="mailc" value="<?PHP echo $_GET['mail'];?>">
...
if (isset($_POST['modifier'])){
	$LivreurC=new Livreur( $_POST['nom'],$_POST['mail'],$_POST['tel'],$_POST['permis'],$_POST['date']);
	$LivreurC->modifierlivraison($Livreur,$_POST['mailc']);
 // echo "<META http-equiv='refresh' content='0;URL=formelements.php'>";
}
?>
				...
				<div class="popup-box chat-popup" id="qnimate">
					<div class="popup-head">
						<div class="popup-head-left pull-left"><img src="assets/img/avatar/avatar-3.jpg" alt="iamgurdeeposahan" class="mr-2"> Moetez Boubakri</div>
...
<!-- Mirrored from www.spruko.com/demo/splite/formwizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Feb 2019 18:34:51 GMT -->
</html>